...
mbus_error_str_set(char *message)
{
    if (message)
    {
        snprintf(error_str, sizeof(error_str)-1, "%s", message);
    }
}
...
//------------------------------------------------------------------------------
ADDAPI mbus_frame_data * ADDCALL
mbus_frame_data_new()
{
...
//------------------------------------------------------------------------------
ADDAPI mbus_data_record * ADDCALL
