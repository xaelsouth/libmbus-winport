...
typedef struct _mbus_handle {
    ...
    void *auxdata;
	long tcp_timeout_sec;
	long tcp_timeout_usec;
} mbus_handle;
...
// Event register functions
//
ADDAPI void ADDCALL mbus_register_recv_event(mbus_handle *handle, void(*event)(unsigned char src_type, const char *buff, size_t len));
ADDAPI void ADDCALL mbus_register_send_event(mbus_handle *handle, void(*event)(unsigned char src_type, const char *buff, size_t len));
ADDAPI void ADDCALL mbus_register_scan_progress(mbus_handle *handle, void(*event)(mbus_handle *handle, const char *mask));
ADDAPI void ADDCALL mbus_register_found_event(mbus_handle *handle, void(*event)(mbus_handle *handle, mbus_frame *frame));
 ...
 */
ADDAPI mbus_handle * ADDCALL mbus_context_serial(const char *device);
 ...
 * @return Initialized "unified" handler when successful, NULL otherwise;
 */
ADDAPI mbus_handle * ADDCALL mbus_context_tcp(const char *host, uint16_t port);
 ...
 *
 */
ADDAPI void ADDCALL mbus_context_free(mbus_handle * handle);
 ...
 */
ADDAPI int ADDCALL mbus_connect(mbus_handle * handle);
 ...
 * @return Zero when successful.
 */
ADDAPI int ADDCALL mbus_disconnect(mbus_handle * handle);
 ...
 * @return Zero when successful.
 */
ADDAPI int ADDCALL mbus_context_set_option(mbus_handle * handle, mbus_context_option option, long value);
 ...
 * @return Zero when successful.
 */
ADDAPI int ADDCALL mbus_recv_frame(mbus_handle * handle, mbus_frame *frame);
 ...
 * @return Zero when successful.
 */
ADDAPI int ADDCALL mbus_send_frame(mbus_handle * handle, mbus_frame *frame);
 ...
 * @return Zero when successful.
 */
ADDAPI int ADDCALL mbus_send_select_frame(mbus_handle * handle, const char *secondary_addr_str);
 ...
 * @return Zero when successful.
 */
ADDAPI int ADDCALL mbus_send_application_reset_frame(mbus_handle * handle, int address, int subcode);
 ...
 * @return Zero when successful.
 */
ADDAPI int ADDCALL mbus_send_switch_baudrate_frame(mbus_handle * handle, int address, long baudrate);
 ...
 * @return Zero when successful.
 */
ADDAPI int ADDCALL mbus_send_request_frame(mbus_handle * handle, int address);
 ...
 * @return Zero when successful.
 */
ADDAPI int ADDCALL mbus_send_user_data_frame(mbus_handle * handle, int address, const unsigned char *data, size_t data_size);
 ...
 * @return Zero when successful.
 */
ADDAPI int ADDCALL mbus_sendrecv_request(mbus_handle *handle, int address, mbus_frame *reply, int max_frames);
 ...
 * @return Zero when successful.
 */
ADDAPI int ADDCALL mbus_send_ping_frame(mbus_handle *handle, int address, char purge_response);
 ...
 */
ADDAPI int ADDCALL mbus_select_secondary_address(mbus_handle * handle, const char *mask);
 ...
 * @return See MBUS_PROBE_* constants
 */
ADDAPI int ADDCALL mbus_probe_secondary_address(mbus_handle * handle, const char *mask, char *matching_addr);
 ...
 * @return Zero when successful.
 */
ADDAPI int ADDCALL mbus_read_slave(mbus_handle *handle, mbus_address *address, mbus_frame *reply);
 ...
 */
ADDAPI mbus_record * ADDCALL mbus_record_new();
 ...
 */
ADDAPI void ADDCALL mbus_record_free(mbus_record *rec);
 ...
 */
ADDAPI mbus_record * ADDCALL mbus_parse_fixed_record(char statusByte, char medium_unit_byte, unsigned char *data);
 ...
 * @return Newly allocated record if succesful, NULL otherwise. Later on need to use #mbus_record_free
 */
ADDAPI mbus_record * ADDCALL mbus_parse_variable_record(mbus_data_record *record);
 ...
 * @return zero when OK
 */
ADDAPI int ADDCALL mbus_data_fixed_normalize(int medium_unit_byte, long medium_value, char **unit_out, double *value_out, char **quantity_out);
 ...
 * @return zero when OK
 */
ADDAPI int ADDCALL mbus_variable_value_decode(mbus_data_record *record, double *value_out_real, char **value_out_str, int *value_out_str_size);
 ...
 * @return zero when OK
 */
ADDAPI int ADDCALL mbus_vif_unit_normalize(int vif, double value, char **unit_out, double *value_out, char **quantity_out);
 ...
 * @return zero when OK
 */
ADDAPI int ADDCALL mbus_vib_unit_normalize(mbus_value_information_block *vib, double value, char **unit_out, double *value_out, char ** quantity_out);
 ...
 */
ADDAPI char * ADDCALL mbus_data_variable_xml_normalized(mbus_data_variable *data);
 ...
 * @return string with XML
 */
ADDAPI char * ADDCALL mbus_frame_data_xml_normalized(mbus_frame_data *data);
 ...
 * @return zero when OK
 */
ADDAPI int ADDCALL mbus_scan_2nd_address_range(mbus_handle * handle, int pos, char *addr_mask);
 ...
 */
ADDAPI size_t ADDCALL mbus_hex2bin(unsigned char * dst, size_t dst_len, const unsigned char * src, size_t src_len);
