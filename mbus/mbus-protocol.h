...
//
ADDAPI unsigned int ADDCALL mbus_manufacturer_id(char *manufacturer);
...
//
ADDAPI void ADDCALL mbus_dump_recv_event(unsigned char src_type, const char *buff, size_t len);
ADDAPI void ADDCALL mbus_dump_send_event(unsigned char src_type, const char *buff, size_t len);

//
// variable length records
//
ADDAPI mbus_data_record * ADDCALL mbus_data_record_new();
ADDAPI void ADDCALL mbus_data_record_free(mbus_data_record *record);
ADDAPI void ADDCALL mbus_data_record_append(mbus_data_variable *data, mbus_data_record *record);


// XXX: Add application reset subcodes

ADDAPI mbus_frame * ADDCALL mbus_frame_new(int frame_type);
ADDAPI int ADDCALL mbus_frame_free(mbus_frame *frame);

ADDAPI mbus_frame_data * ADDCALL mbus_frame_data_new();
ADDAPI void ADDCALL mbus_frame_data_free(mbus_frame_data *data);

//
//
//
ADDAPI int ADDCALL mbus_frame_calc_checksum(mbus_frame *frame);
ADDAPI int ADDCALL mbus_frame_calc_length(mbus_frame *frame);

//
// Parse/Pack to bin
//
ADDAPI int ADDCALL mbus_parse(mbus_frame *frame, unsigned char *data, size_t data_size);

ADDAPI int ADDCALL mbus_data_fixed_parse(mbus_frame *frame, mbus_data_fixed    *data);
ADDAPI int ADDCALL mbus_data_variable_parse(mbus_frame *frame, mbus_data_variable *data);

ADDAPI int ADDCALL mbus_frame_data_parse(mbus_frame *frame, mbus_frame_data *data);

ADDAPI int ADDCALL mbus_frame_pack(mbus_frame *frame, unsigned char *data, size_t data_size);

ADDAPI int ADDCALL mbus_frame_verify(mbus_frame *frame);

ADDAPI int ADDCALL mbus_frame_internal_pack(mbus_frame *frame, mbus_frame_data *frame_data);
...
//
ADDAPI int ADDCALL mbus_str_xml_encode(unsigned char *dst, const unsigned char *src, size_t max_len);
ADDAPI char * ADDCALL mbus_data_variable_xml(mbus_data_variable *data);
ADDAPI char * ADDCALL mbus_data_fixed_xml(mbus_data_fixed *data);
ADDAPI char * ADDCALL mbus_data_error_xml(int error);
ADDAPI char * ADDCALL mbus_frame_data_xml(mbus_frame_data *data);

ADDAPI char * ADDCALL mbus_data_variable_header_xml(mbus_data_variable_header *header);

ADDAPI char * ADDCALL mbus_frame_xml(mbus_frame *frame);

//
// Debug/dump
//
ADDAPI int ADDCALL mbus_frame_print(mbus_frame *frame);
ADDAPI int ADDCALL mbus_frame_data_print(mbus_frame_data *data);
ADDAPI int ADDCALL mbus_data_fixed_print(mbus_data_fixed *data);
ADDAPI int ADDCALL mbus_data_error_print(int error);
ADDAPI int ADDCALL mbus_data_variable_header_print(mbus_data_variable_header *header);
ADDAPI int ADDCALL mbus_data_variable_print(mbus_data_variable *data);

ADDAPI char * ADDCALL mbus_error_str();
ADDAPI void ADDCALL mbus_error_str_set(char *message);
ADDAPI void ADDCALL mbus_error_reset();

ADDAPI void ADDCALL mbus_parse_set_debug(int debug);
ADDAPI void ADDCALL mbus_hex_dump(const char *label, const char *buff, size_t len);
...
ADDAPI long long ADDCALL mbus_data_bcd_decode(unsigned char *bcd_data, size_t bcd_data_size);
ADDAPI int ADDCALL mbus_data_int_decode(unsigned char *int_data, size_t int_data_size, int *value);
ADDAPI int ADDCALL mbus_data_long_decode(unsigned char *int_data, size_t int_data_size, long *value);
ADDAPI int ADDCALL mbus_data_long_long_decode(unsigned char *int_data, size_t int_data_size, long long *value);

ADDAPI float ADDCALL mbus_data_float_decode(unsigned char *float_data);

ADDAPI void ADDCALL mbus_data_tm_decode(struct tm *t, unsigned char *t_data, size_t t_data_size);

ADDAPI void ADDCALL mbus_data_str_decode(unsigned char *dst, const unsigned char *src, size_t len);
...
ADDAPI int ADDCALL mbus_is_secondary_address(const char * value);
